...
public final class Unpack extends Unpack20 {
    ...
    private void unpack29(boolean solid) throws IOException {
        ...
        while (true) {
            ...
            UnpWriteBuf();
            if (writtenFileSize > destUnpSize || suspended) {
                return;
            }
            }
    ...
    private void UnpWriteBuf() throws IOException {
        ...
        for (int I = 0; I < prgStack.size(); I++) {
            ...
            if (BlockLength <= WriteSize) {
                ...
                System.arraycopy(rarVM.getMem(), FilteredDataOffset, FilteredData, 0, FilteredDataSize);
    ...
    private boolean readVMCodePPM() throws IOException {
    ...
    private boolean addVMCode(int firstByte, List<Byte> vmCode) {
