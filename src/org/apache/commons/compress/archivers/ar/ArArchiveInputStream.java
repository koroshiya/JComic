...
//        GNU ar uses a '/' to mark the end of the filename; this allows for the use of spaces without the use of an extended filename.
    ...
    public static boolean matches(byte[] signature, int length) {
        return !(length < 8 || signature[0] != 0x21 || signature[1] != 0x3c || signature[2] != 0x61 ||
                signature[3] != 0x72 || signature[4] != 0x63 || signature[5] != 0x68 || signature[6] != 0x3e || signature[7] != 0x0a);
    }
